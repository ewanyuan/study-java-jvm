...
public class UsingJreClassAbstractor {

    public static void main(String[] args) throws Exception {
        String mainJar;
        String classDenpdencyFile;
        if (args != null && args.length == 2) {
            mainJar = args[0];
            classDenpdencyFile = args[1];
        } else {
            mainJar = "/Library/Java/JavaVirtualMachines/jdk1.8.0_131.jdk/Contents/Home/jre/lib/rt.jar";
            classDenpdencyFile = "/Users/ewan/study/jvm/console.log";
        }
